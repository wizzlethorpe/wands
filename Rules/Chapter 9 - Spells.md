...
Casting Unforgivable Curses or killing a being with a Dark spell should prompt a corruption roll, as outlined in [[Chapter 8 - Dark Magic|Chapter 8: Dark Magic Corruption]].
...
If a target of the [[Legilimens|legilimens]] spell has the Occlumency Training feat, their training gives them the chance to make a Wisdom saving throw to resist the intrusion into their mind.

### Patronus Casting

The [[Expecto Patronum|patronus charm]] is a special bit of magic that requires a wizard to envision one of their happiest memories while casting the spell. If the feeling of happiness is not genuine or not strong enough, the casting attempt will fail.

A wizard's corporeal patronus is also the animal that they will transform into during their animagus transformation. Use [[Appendix B - Patronus Tables|Appendix B: Patronus Rolling Tables]] to determine its shape.

---

## Spell Conversions

Many W&W spells have 5e equivalents. See the [[Compendium/Items|Items]] section for potion conversions.

| W&W Spell | 5e Equivalent |
|:----------|:--------------|
| [[Accio|Accio]] | Mage Hand |
| [[Alohomora|Alohomora]] | Knock |
| [[Confundo|Confundo]] | Confusion, Suggestion |
| [[Depulso|Depulso]] | Arcane Hand |
| [[Engorgio|Engorgio]] | Enlarge |
| [[Expelliarmus|Expelliarmus]] | - (unique) |
| [[Finite Incantatem|Finite Incantatem]] | Dispel Magic |
| [[Glacius|Glacius]] | Shape Water |
| [[Incendio|Incendio]] | Fire Bolt, Produce Flame |
| [[Compendium/Spells/Lumos _ Nox|Lumos]] | Light |
| [[Obliviate|Obliviate]] | Modify Memory |
| [[Protego|Protego]] | Shield |
| [[Reducio|Reducio]] | Reduce |
| [[Reparo|Reparo]] | Mending |
| [[Silencio|Silencio]] | Silence |
| [[Stupefy|Stupefy]] | - (unique) |
| [[Wingardium Leviosa|Wingardium Leviosa]] | Levitate |


## Spell List

For the complete list of spells available in Wands & Wizards, browse the [[Compendium/Spells|Spells]] compendium below. Each spell includes its level, school, casting time, range, components, duration, and full description.
