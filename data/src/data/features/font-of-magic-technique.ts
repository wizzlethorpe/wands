...
/**
 * Technique-specific variant of Font of Magic. Granted by the Technique Caster class
 ...
 */
export const fontOfMagicTechnique = FeatureSchema.parse({
  id: "font-of-magic-technique",
  foundryId: "b5afec42331ed2df",
  type: "feat",
  featureType: "class",
  source: "W&W p.10",
  ...
  uses: { value: null, max: "@scale.technique-caster.sorcery-points", per: "lr", recovery: "" },
